...
<head>
    ...
    <link rel="icon" href="./assets/dist/img/favicon/favicon-16x16.png" sizes="16x16" />
    <link rel="icon" href="./assets/dist/img/favicon/favicon-32x32.png" sizes="32x32" />
    <link rel="icon" href="./assets/dist/img/favicon/android-chrome-192x192.png" sizes="192x192" />
    <link rel="icon" href="./assets/dist/img/favicon/android-chrome-512x512.png" sizes="512x512" />
    <link rel="apple-touch-icon" href="./assets/dist/img/favicon/" />
    <meta name="msapplication-TileColor" content="#000000">
	  <meta name="msapplication-TileImage" content="./assets/dist/img/favicon/favicon.ico">
</head>
<body>

<!-- header -->
<div class="container">
<a href="/" class="d-flex align-items-center justify-content-center mb-1 mt-3 text-decoration-none mx-auto">
      <img class="bi me-2" width="62" height="62" src="./assets/dist/img/logo.svg"></img>
    </a>
  <nav class="navbar navbar-expand-lg rounded py-3 mb-4 border-bottom" aria-label="Twelfth navbar example">
        ...
        <div class="navbar-collapse justify-content-md-center collapse" id="navbarsExample10" style="">
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle disabled" href="#" data-bs-toggle="dropdown" aria-expanded="false">Account</a>
...
<div class="container">
  <footer class="py-3 my-4">
    <a href="/" class="d-flex align-items-center justify-content-center mb-3 mb-md-0 me-md-auto text-decoration-none mx-auto">
